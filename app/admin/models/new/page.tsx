        ...
        <div className="bg-[#1a1f2e] border border-[#1b3caf]/30 rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  {categoryFeatures.map((f) => (
                    <div key={f.id} className="flex items-center gap-3">
                      <label className="w-48 text-sm text-[#b0b0b0]">
                        {f.label}
                      </label>
                      <div className="flex-1">
                        {f.type === "boolean" && (
                          <input
                            ...
                            className="w-4 h-4 accent-[#1b3caf]"
                          />
                        )}
                        {f.type === "number" && (
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-lg bg-[#242d3d] border border-[#1b3caf]/20 text-white"
                          />
                        )}
                        {f.type === "date" && (
                          <input
                        ...
                        {f.type === "enum" && (
                          ...
                          >
                            ...
                            {(f.options ? JSON.parse(f.options) : []).map(
                              (opt: any, i: number) => (
            ...
            <div>
              ...
              <div
                className={`border-2 border-dashed rounded-lg p-6 text-center transition cursor-pointer mb-6 ${
                  uploadingFile
                    ? "border-[#1b3caf] bg-[#1b3caf]/10"
                    : "border-[#1b3caf]/30 hover:border-[#1b3caf]/60 bg-[#242d3d]/50"
                }`}
                onClick={() =>
              ...
              >
                ...
                {uploadingFile ? (
                  <p className="text-[#1b3caf]">Przesyłanie...</p>
                ) : (
                  <>
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-8 h-8 mx-auto mb-2 text-[#6b7280]"
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    <p className="text-sm text-[#b0b0b0]">
                      Kliknij, aby dodać plik (np. PDF, specyfikacja)
                    </p>
                  </>
                )}
              </div>
                  ...
                  {downloads.map((file, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-3 overflow-hidden">
                        <div className="bg-[#1b3caf]/20 p-2 rounded">
                          <span className="text-xs font-bold text-[#1b3caf] uppercase">
                            {file.fileType}
                          </span>
                        </div>
