...
// Removed UnifiedNavbar, Footer, LoadingScreen imports
import {
  ChevronLeft,
  ChevronRight,
  Phone,
...
export function ProductClient({
  ...
  useEffect(() => {
    ...
    if (model.variantGroups) {
      model.variantGroups.forEach((group: any) => {
    ...
    if (model.accessories) setAccessories(model.accessories);
  ...
  // Removed fetchModel and error handling blocks
