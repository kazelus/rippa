  ...
  try {
    ...
    if (!submitBtn) {
      ...
      for (const b of buttons) {
        ...
        if (
          typeof txt === "string" &&
          (txt.toLowerCase().includes("zalog") ||
    ...
    await page.screenshot({
      path: `${outDir}/real-dashboard.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `${outDir}/real-models-list.png`,
      fullPage: true,
    });

    // Add model page
    await page.goto(`${adminUrl}/admin/models/new`, {
      waitUntil: "networkidle2",
    });
    await page.screenshot({
      path: `${outDir}/real-add-model.png`,
      fullPage: true,
    });
    ...
    if (editLink) {
      ...
      await page
        ...
        .catch(() => {});
      await page.screenshot({
        path: `${outDir}/real-edit-model.png`,
        fullPage: true,
      });
    } else {
      console.warn(
        "No edit link found on models list. Skipping edit screenshot.",
      );
    }
